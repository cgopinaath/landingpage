          ...
          <div className="bg-white rounded-xl shadow-sm p-8">
            ...
            <form className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="inline-flex items-center justify-center w-full px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors duration-300"
                >
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@highgreeves.com</p>
                  <p className="text-gray-600">support@highgreeves.com</p>
                </div>
              </div>
              <div className="flex items-start">
